...
| D63 | Deck-level diff: added and removed passages between two versions, by layer, from the chunks already stored per version | 5.4 | 5.5 | The literal question ("what changed in the brief") as opposed to what changed between the two reviews of it |
