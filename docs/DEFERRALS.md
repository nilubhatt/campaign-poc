...
| C17 | An offer whose arguments the user must supply had no defined shape (was D43) | 5.6 — `needs` lists them, and 5.5's review added a test that checks it structurally against the tool's required parameters |
